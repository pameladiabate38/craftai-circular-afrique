...
[data-testid="stChatMessage"] p, [data-testid="stChatMessage"] span, [data-testid
...
<p>Un prototype IA local pour transformer les chutes artisanales en creations utiles,
</div>
""",
unsafe_allow_html=True,
)
